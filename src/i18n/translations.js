export const translations = {
  en: {
    ...
    protocol_title: 'Communication_Protocols',
    contact_title: 'READY TO DEPLOY?',
    contact_btn: 'COPY MAIL',
    contact_copied: 'MAIL COPIED',
    view_project: 'VIEW PROJECT SPEC',
    view_github: 'VIEW GITHUB SOURCE',
    CONNECT_LINKEDIN: 'CONNECT ON LINKEDIN',
    footer_text: 'System Protocol Active • George Sakran',
    ...
    project_specs: "TECHNICAL_SPECIFICATIONS_MANIFEST",
    project_tech_stack: "DEPLOYED_STACK",
    project_features: "VALIDATED_FEATURES",
    cv_name: 'George Sakran',
    cv_title_sub: 'Software Practical Engineer',
    cv_address: 'Elnofaji 3, Reineh, Israel',
    cv_summary: 'Highly motivated Software Practical Engineer, graduate of the Technion School. Experienced in technical support and application troubleshooting, with a strong foundation in Full-Stack development (React, Node.js, SQL). Quick learner, fluent in English and Hebrew, seeking to leverage technical skills in a QA Automation or Junior Developer role.',
    job1_date: 'JUNE 2024 - PRESENT',
    job1_company: 'Leen Computers, Nazareth',
    job1_role: 'Technical Support (Tier 2)',
    job1_points: [
      "Provide Tier 2 technical support for proprietary web applications, ensuring high system uptime.",
      "Perform remote troubleshooting and debugging via AnyDesk to resolve complex client-side and server-side issues.",
      "Collaborate with the development team on Full-Stack feature enhancements and application maintenance.",
      "Manage and query SQL databases to identify and resolve data-related discrepancies."
    ],
    job2_date: 'SEPTEMBER 2020 - MAY 2024',
    ...
    lang_ar: 'Arabic: Native Engine',
    lang_en: 'English: Proficient (High-level reading, writing, speaking)',
    lang_he: 'Hebrew: Proficient (Excellent professional communication)'
  },
  he: {
    dir: 'rtl',
    label: 'עב',
    ...
    protocol_title: ' פרוטוקולי תקשורת',
    contact_title: 'מוכן להשקה?',
    contact_btn: 'העתק מפתח גישה',
    contact_copied: 'הועתק',
    view_project: 'הצג מפרט פרויקט',
    view_github: 'הצג קוד ב-GitHub',
    footer_text: 'פרוטוקול מערכת פעיל • ג׳ורג׳ סקראן',
    CONNECT_LINKEDIN: 'התחבר ב-LinkedIn',
    cv_sec_summary: 'תקציר מקצועי',
    cv_sec_skills: 'ארגז כלים טכנולוגי',
    cv_sec_experience: 'ניסיון תעסוקתי',
    cv_sec_projects: 'פרויקטים טכניים',
    cv_sec_education: 'השכלה_והסמכות',
    cv_sec_languages: 'שפות מערכת',
    cv_back_btn: "חזרה_לפרויקטים.sh",
    project_specs: "מפרט טכני מערכתי",
    project_tech_stack: "סטאק טכנולוגי בשימוש",
    project_features: "תכונות מערכת מאומתות",
    cv_name: 'ג׳ורג׳ סקראן',
    cv_title_sub: 'הנדסאי תוכנה מוסמך',
    cv_address: 'אלנופאג׳י 3, ריינה, ישראל',
    cv_summary: 'הנדסאי תוכנה בעל מוטיבציה גבוהה, בוגר בית הספר להנדסאים של הטכניון. בעל ניסיון בתמיכה טכנית ופתרון תקלות באפליקציות, עם בסיס חזק בפיתוח Full-Stack (React, Node.js, SQL). לומד מהר, שולט באנגלית ובעברית, ומחפש למנף את הכישורים הטכניים לתפקיד QA Automation או מפתח ג׳וניור.',
    job1_date: 'יוני 2024 - הווה',
    job1_company: 'לין מחשבים, נצרת',
    job1_role: 'תמיכה טכנית (Tier 2)',
    job1_points: [
      "מתן תמיכה טכנית דרג 2 עבור אפליקציות אינטרנט ייעודיות, תוך שמירה על זמינות מערכת גבוהה.",
      "ביצוע פתרון תקלות וניפוי באגים מרחוק באמצעות AnyDesk לפתרון בעיות מורכבות בצד הלקוח ובצד השרת.",
      "שיתוף פעולה עם צוות הפיתוח בשיפורי תכונות Full-Stack ותחזוקת אפליקציות.",
      "ניהול ותשאול מסדי נתונים של SQL לזיהוי ופתרון אי-תאימויות נתונים."
    ],
    job2_date: 'ספטמבר 2020 - מאי 2024',
    job2_company: 'מפעל טוסקה, מגדל העמק',
    job2_role: 'מנהל אזור ייצור',
    job2_points: [
      "הובלה וניהול של מחלקות ייצור, פיקוח על תפעול יומי ועמידה ביעדים.",
    ...
    lang_ar: 'ערבית: שפת אם',
    lang_en: 'אנגלית: רמה גבוהה מאוד (קריאה, כתיבה, דיבור)',
    lang_he: 'עברית: רמה מקצועית גבוהה (תקשורת עסקית מעולה)'
  },
  ar: {
    dir: 'rtl',
    label: 'عرب',
    ...
    protocol_title: ' بروتوكولات الاتصال',
    contact_title: 'هل أنت جاهز للتشغيل؟',
    contact_btn: 'نسخ_مفتاح الدخول',
    contact_copied: 'تم النسخ',
    view_project: 'عرض تفاصيل المشروع',
    view_github: 'عرض الكود على GitHub',
    footer_text: 'بروتوكول النظام نشط • جورج صكران',
    CONNECT_LINKEDIN: 'تواصل عبر LinkedIn',
    cv_sec_summary: 'الملخص المهني',
    cv_sec_skills: 'المهارات التقنية',
    cv_sec_experience: 'الخبرة العملية',
    cv_sec_projects: 'المشاريع التقنية',
    cv_sec_education: 'المؤهل الأكاديمي',
    cv_sec_languages: 'اللغات',
    cv_back_btn: "الرجوع الى قائمة المشاريع",
    project_specs: "المواصفات الفنية للمشروع",
    project_tech_stack: "التقنيات المستخدمة",
    project_features: "الميزات المدققة",
    cv_name: 'جورج صكران',
    cv_title_sub: 'مهندس برمجيات عملي (هندساي)',
    cv_address: 'النووفجي 3، الرينة، إسرائيل',
    cv_summary: 'مهندس برمجيات عملي طموح، خريج كلية التخنيون للهندسة العملية. ذو خبرة في الدعم الفني واستكشاف أخطاء التطبيقات وإصلاحها، مع أساس قوي في تطوير الـ Full-Stack (React, Node.js, SQL). سريع التعلم، متحدث طليق باللغتين الإنجليزية والعبرية، وأتطلع لاستغلال مهاراتي التقنية في دور أتمتة الفحص (QA Automation) أو كمطور برمجيات مبتدئ.',
    job1_date: 'يونيو 2024 - الحاضر',
    job1_company: 'لين للكمبيوتر، الناصرة',
    job1_role: 'الدعم الفني (Tier 2)',
    job1_points: [
      "تقديم الدعم الفني من المستوى الثاني لتطبيقات الويب الخاصة، مما يضمن استمرارية تشغيل النظام وكفاءته العالية.",
      "إجراء استكشاف الأخطاء وإصلاحها عن بُعد عبر AnyDesk لحل المشكلات المعقدة لجانب العميل والخادم.",
      "التعاون مع فريق التطوير في تحسين ميزات الـ Full-Stack وصيانة التطبيقات الحالية.",
      "إدارة واستعلام قواعد بيانات SQL لتحديد وحل أي تضارب أو اختلافات في البيانات."
    ],
    job2_date: 'سبتمبر 2020 - مايو 2024',
    ...
    lang_en: 'الإنجليزية: مستوى متقدم (قراءة، كتابة، ومحادثة بمستوى عالٍ)',
    lang_he: 'العبرية: مستوى متقدم (تواصل مهني ممتاز)'
  }
};
...
export const projectsData = [
  {
    ...
    link: "https://github.com/Georgesakran/smart-support",
    content: {
      en: {
        title: "SMART_SUPPORT",
        sub: "CLIENT INFRASTRUCTURE",
        desc: "Automated routing pipeline built to assist technical support environments with rapid remote query lookups and data resolution interfaces.",
        features: ["Integrated secure data synchronization loops.", "Automated server lookup parameters with optimization routines."]
      },
      he: {
        title: "SMART_SUPPORT",
        sub: "תשתית לקוחות ומערכת ניתוב",
        desc: "מערכת אוטומטית שנבנתה כדי לסייע לצוותי תמיכה טכנית בביצוע שאילתות מהירות ופתרון בעיות נתונים.",
        features: ["אינטגרציה של לולאות סנכרון נתונים מאובטחות.", "פרמטרים של חיפוש שרת אוטומטי עם שגרות אופטימיזציה."]
      },
      ar: {
        title: "SMART_SUPPORT",
