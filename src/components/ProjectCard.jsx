...
export default function ProjectCard({ project, index, language, t }) {
  ...
  return (
    <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 lg:gap-16 items-center mb-28`}>
      ...
      <div className="w-full lg:w-5/12 group relative">
        ...
        <div className="relative bg-slate-900/30 border border-slate-800/60 p-2 rounded-3xl backdrop-blur-3xl overflow-hidden">
          {/* FIXED TYPO: Separated aspect-16/10 and background color utility */}
          <div className="aspect-16/10 bg-[#030712] rounded-2xl flex items-center justify-center relative overflow-hidden">
            <div
            ...
            <div className="relative z-10 text-center p-4">
              <div className="w-14 h-14 bg-linear-to-tr from-blue-600/80 to-indigo-900/80 rounded-2xl flex items-center justify-center mx-auto mb-3 shadow-xl border border-white/5">
